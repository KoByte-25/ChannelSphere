        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          <div class="page-heading">
            <div class="page-heading-copy">
              ...
              <div>
                <p class="eyebrow mb-1">ထရပ် နံပါတ်</p>
                <h1 class="h3 mb-1"><?php echo $tno; ?> </h1>
          ...
          <?php
          $selectPosition = "SELECT * from truck where truck_no=:tno";
          $stmtP = $pdo->prepare($selectPosition);
          $stmtP->execute([':tno' => $tno]);
          $resultP = $stmtP->fetch();
  ...
  <!-- Local Leaflet JS -->
    ...
    <script>
      ...
      async function fetchLatestPosition() {
          try {
              const response = await fetch('./get_truck_position_by_truck_no.php?tno=' + encodeURIComponent(tno));
