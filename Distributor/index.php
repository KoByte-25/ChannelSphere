  ...
  <main class="auth-page">
    <section class="auth-card">
      ...
      <form class="needs-validation" action="" method="post" novalidate>
        <div class="mb-4">
          <p class="eyebrow mb-1">ပစ္စည်း ပို့ရန် ကုမ္ပဏီ သို့မဟုတ် Moderator အနေဖြင့်</p>
      ...
      <div class="auth-footer">ကုမ္ပဏီ အကောင့်မရှိသေးဘူးလား? <a href="./register.php">ကုမ္ပဏီ အကောင့်ဖွင့်ပါ</a></div>
    </section>
  </main>
