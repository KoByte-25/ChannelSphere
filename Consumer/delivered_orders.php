  ...
  <div class="admin-shell">
    ...
    <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
      ...
      <nav class="sidebar-nav">
        ...
        <a class="nav-link active" href="./delivered_orders.php" aria-current="page">
        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          <div class="page-heading">
            <div class="page-heading-copy">
              ...
              <div>
                <p class="eyebrow mb-1">ရောက်ရှိပြီးသား</p>
                <h1 class="h3 mb-1">အော်ဒါများ</h1>
                <p class="text-muted mb-0"><?php echo $cusUN; ?> မှာထားပြီး ရောက်ရှိပြီးသွားသော အော်ဒါများမှာ</p>
              </div>
            </div>
              ...
              <table class="table align-middle mb-0" id="ordersTable" data-searchable-table>
                <thead>
                  <tr>
                    ...
                    <th class="text-end">ရောက်ရှိသည့် ရက်</th>
                  </tr>
                </thead>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><span class="badge text-bg-success"><?php  echo $r["delivery_status"]; ?></span> </td>
