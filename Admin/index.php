  ...
  <main class="auth-page">
    <section class="auth-card">
      ...
      <form class="needs-validation" action="" method="post" novalidate>
        <div class="mb-4">
          <p class="eyebrow mb-1">ရေမှာ ဖို့ အကောင့်ဝင်ပါ။</p>
        ...
        <div class="mb-3"><div class="d-flex justify-content-between"><label class="form-label" for="loginPassword">လျှို့ဝှက်နံပါတ်</label><!--<a class="small fw-semibold" href="forgot-password.html">Forgot?</a> --></div><input class="form-control" id="loginPassword" type="password" name="pwd" required><div class="invalid-feedback">မှန်ကန်သော လျှို့ဝှက်နံပါတ်ထည့်ပေးပါ</div><p style="color: red; padding: 3px;"><?php  echo isset($_GET['logPwdErrMsg']) ? $_GET['logPwdErrMsg'] : '';  ?></p></div>
