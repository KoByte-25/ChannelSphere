  ...
  <main class="auth-page">
    <section class="auth-card">
      ...
      <form class="needs-validation" action="" method="POST" novalidate>
        <div class="mb-4">
          <p class="eyebrow mb-1">ရေမှာဖို့ အကောင့်ဖွင့်ရန် လိုအပ်ပါသည်။</p>
        ...
        <div class="mb-3"><label class="form-label" for="registerPassword">လျှို့ဝှက်နံပါတ်</label><input class="form-control" id="registerPassword" type="password" name="pwd" required><div class="invalid-feedback">မှန်ကန်သော လျှို့ဝှက်နံပါတ်ထည့်ပေးပါ</div><p style="color: red; padding: 3px; font-size: 12px;" id="pwd-error"></p></div>
